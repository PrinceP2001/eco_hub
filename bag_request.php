...
$query=mysqli_query($conn,"SELECT * FROM paper_bag_tb WHERE bag_id='$bag_id'"); 
...
if(isset($_POST['sub']))
{
    ...
    mysqli_query($conn,"INSERT INTO bag_req_tb (`bag_id`,`reg_id`, `date`, `req_quantity`) VALUES ('$bag_id','$reg_id','$ex_date','$quantity')");
...
<div class="cart-main-area pt-130 pb-130">
    <div class="container">
        <h3 class="cart-page-title">request</h3>
        <div class="row">
                        ...
                        <table style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <a href="#"><img src="admin/image/<?php echo $row['bag_image'];?>" width="100" height="100" alt=""></a>
                                         <input class="cart-plus-minus-box" type="text" value="<?php echo $row['bag_id'];?>" name="cart[]" hidden="ture">
                                        
                                    </td>
                                    <td class="product-name"><a href=""><?php echo $row['model_name'];?></a></td>
                                    <td><input type="date" name="date" onclick="clrmsg('spdate')" id="date_id"> <span id="spdate" style="color: red;"></span></td>
                                  
                                     <td class="product-quantity">
                                        <div class="cart-plus-minus" style="margin-left:30%; ">
                                            <input class="cart-plus-minus-box" id="qua" type="number" onclick="clrmsg('spq')" name="quanti" value="1"> <span id="spq" style="color: red;">
                              ...
                              <?php } ?>
                                        ...
                                        <button class="default-btn text-center mt-20" style="background-color: white; float: right;" onclick="return validate()" type="submit" name="sub"><i style="color:green;">CONFIRM REQUEST</i></button>
...
<script>
    function validate()
    {
        ...
        if(date=="")
        {
            document.getElementById('spdate').innerHTML="* select date";
            return false;
        }
        if(q=="")
        {
            document.getElementById('spq').innerHTML="* select quantity";
            return false;
        }
    }
    function clrmsg(p)
