...
if(isset($_POST['sub']))
{
    ...
    {
        $fetch=mysqli_query($conn,"INSERT INTO `equipment_tb`(`equipment_name`, `description`, `quantity`,`rent_rate`, `image`, `current_quantity`) VALUES('$nm','$ds','$qua','$dayrate','$file_name','$qua')"); 

    echo "<script>alert('new equipment added');</script>";
    echo "<script>window.location.href='add_equipment.php'</script>";
